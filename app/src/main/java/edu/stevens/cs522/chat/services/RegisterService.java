            ...
            try {
                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        ...
                        notificationBuilder.setContentText(getText(R.string.register_success));
                        ...
                        // DO NOT DISPLAY A TOAST (It's unsafe.  Why?)
                        notificationBuilder.setContentText(getText(R.string.register_failed_notification_message));
