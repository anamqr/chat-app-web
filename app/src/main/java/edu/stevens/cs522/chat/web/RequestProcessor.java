...
public class RequestProcessor {
    ...
    public ChatServiceResponse perform(SynchronizeRequest request) {
        ...
        try {
             ...
             * These uploads will be processed by the server.  The downloads it pushes to us will be
             ...
             */
            List<Message> unsentMessages = chatDatabase.requestDao().getUnsentMessages();
